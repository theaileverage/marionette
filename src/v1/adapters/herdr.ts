...
export function createHerdrCapabilities(driver: HerdrAdapterDriver) {
  // SAFETY: HerdrAdapterDriver is the union of the promise and Effect driver surfaces; optional reads preserve absent methods.
  const effect = driver as Partial<HerdrEffectDriver>;

  // SAFETY: The same driver union includes promise methods, and each method is checked before invocation.
